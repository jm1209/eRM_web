    ...
    var i = layui.$, t = layui.layer, a = layui.hint(), n = layui.device(), l = "form", r = ".layui-form",
        s = "layui-this", o = "layui-hide", c = "layui-disabled", u = function () {
            this.config = {
                verify: {
                    required: [/[\S]+/, "必填项不能为空"],
                    contact: [/^((0\d{2,3}-\d{7,8})|(1[3584]\d{9}))$/, "请输入正确的的联系方式"],
            ...
            select: function () {
                var e, t = "请选择", a = "layui-form-select", n = "layui-select-title", r = "layui-select-none", d = "",
                    f = u.find("select"), v = function (t, l) {
                        ...
                        var y, p = i(this), m = t.find("." + n), k = m.find("input"), g = t.find("dl"),
                            x = g.children("dd"), b = this.selectedIndex;
                        if (!u) {
                            var C = function () {
                                var e = t.offset().top + t.outerHeight() + 5 - h.scrollTop(), i = g.outerHeight();
                            ...
                            m.on("click", function (e) {
                                ...
                                var t = function (i, a) {
                                    ...
                                    if (e.preventDefault(), a = function () {
                                        ...
                                        var r = g.children("dd.layui-this"), o = r.position().top, u = g.height(),
                                            d = r.height();
