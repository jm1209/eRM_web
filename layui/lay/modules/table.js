...
;layui.define(["laytpl", "laypage", "layer", "form"], function (e) {
    ...
    var t = layui.$, i = layui.laytpl, a = layui.laypage, l = layui.layer, n = layui.form, o = layui.hint(),
        ...
        }, s = "table", u = ".layui-table", h = "layui-hide", f = "layui-none", y = "layui-table-view",
        p = ".layui-table-header", m = ".layui-table-body", v = ".layui-table-main", g = ".layui-table-fixed",
        x = ".layui-table-fixed-l", b = ".layui-table-fixed-r", k = ".layui-table-tool", C = ".layui-table-page",
        w = ".layui-table-sort", N = "layui-table-edit", T = "layui-table-hover", F = function (e) {
        ...
        A = t(window), S = t(document), M = function (e) {
            var i = this;
    ...
    M.prototype.config = {
        ...
        if (a.startTime = (new Date).getTime(), n.url) {
            ...
            n.contentType && 0 == n.contentType.indexOf("application/json") && (s = JSON.stringify(s)), t.ajax({
                ...
                headers: n.headers || {},
                success: function (t) {
                    if (t.code == "30002" || t.code == '401') {
                        setTimeout(function () {
                            parent.goLogin();
                           // parent.location.href = '../../../index.html';
                        }, 500)
                    }
                    if (t.data.total < n.limit) {
                        a.layPage.hide()
                    }
                    t[r.statusName] != r.statusCode ? (a.renderForm(),
                        a.layMain.html('<div class="' + f + '">' + (t[r.msgName] || "返回的数据状态异常") + "</div>")) : (a.renderData(t, e, t.data[r.countName]), d(),
                        n.time = (new Date).getTime() - a.startTime + " ms"),
                    i && l.close(i), "function" == typeof n.done && n.done(t, e, t.data[r.countName])
                }
                ,
                error: function (e, t) {
        ...
        u.on("mousemove", function (e) {
            ...
            var e = t(this), l = e.parents("tr").eq(0).data("index"), n = a.layBody.find('tr[data-index="' + l + '"]'),
                o = "layui-table-click", r = d.cache[a.key][l];
