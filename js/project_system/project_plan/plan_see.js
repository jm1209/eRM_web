            ...
            for (var i = 0; i < tasks.length; i++) {
                ...
                for (var j = 0; j < subTaskList.length; j++) {
                    ...
                    var subItem = '<div class="item-list subDel" modifyStatus="' + subTaskList[j].modifyStatus + '" taskId="' + subTaskList[j].taskId + '" leader="' + subTaskList[j].leader + '">' +
                        ...
                        '          <option value="">请选择</option>' +
                        '          <option disabled value="前置" ' + (subTaskList[j].controlProp == "前置" ? "selected" : "") + '>前置</option>' +
                        ...
                        '          </div>' +
                        '          <div class="body win7 lender" leader="' + subTaskList[j].leader + '">' + subTaskList[j].leaderName + '</div>' +
                        '          <div class="body win7">' +
                        '          </div>' +
                        '          </div>';
