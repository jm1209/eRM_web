    ...
    function insertLastTask(lastDailyArr) {
        for (var i = 0; i < lastDailyArr.length; i++) {
            var taskStr = '<div class="task-list" taskId="' + lastDailyArr[i].taskId + '">' +
                ...
                '          <p class="name">历史工作任务————<span>（' + lastDailyArr[i].taskName + '）</span></p>' +
                '          </div>' +
                '          <div class="list">' +
                '<div class="item">' +
                '             <div class="item-row">' +
                ...
                '             <div class="layui-input-block">' +
                '             <textarea disabled placeholder="请输入内容" class="layui-textarea sug">' + lastDailyArr[i].approveRemark + '</textarea>' +
                '             </div>' +
                '             </div>' +
                '              </div>' +
                '               </div>';
    ...
    function insertTask(dailyArr) {
        for (var i = 0; i < dailyArr.length; i++) {
            var taskStr = '<div class="task-list" taskId="' + dailyArr[i].taskId + '">' +
                ...
                '             <label class="layui-form-label">审批意见</label>' +
                '             <div class="layui-input-block">' +
                '             <textarea disabled placeholder="请输入内容" class="layui-textarea sug">' + dailyArr[i].approveRemark + '</textarea>' +
                '             </div>' +
                '             </div>' +
                '              </div>' +
                '               </div>';
